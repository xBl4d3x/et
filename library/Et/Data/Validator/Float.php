<?php
namespace Et;
class Data_Validator_Float extends Data_Validator_Scalar {

	const ERR_TOO_LOW = "too_low";
	const ERR_TOO_HIGH = "too_high";

	const DEF_PRECISION = Data_Validator::DEF_PRECISION;
